...
const Burger: React.FC<BurgerProps> = ({ onClickBurger, onClickCart }) => {
  return (
    <div className="flex flex-col fixed top-0 left-0 bg-white h-full w-full z-30">
      <div className="flex items-center justify-between p-2 bg-lightGreen">
        ...
        <Button onClick={() => onClickBurger(false)} small>
          <svg
            width="10"
            height="10"
            viewBox="0 0 10 10"
      ...
      <ul>
        <li>
          <Button onClick={() => onClickCart(true)}>
            <svg
